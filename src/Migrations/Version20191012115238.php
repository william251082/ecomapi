 ...
 */
final class Version20191012115238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADDE13F470 FOREIGN KEY (taxon_id) REFERENCES taxon (id)');
    }
